...
tableView.addEventListener('click', function(e){
    switch (e.rowData.className) {
        /*case ("dateRow" || "dateRow2"):
            datePickerView.animate(slideOut);
            numerZamowienia_tf.focus();
            break;
            
        case ("dateRow3" || "dateRow4"):
            datePickerView.animate(slideOut);
            nazwaZamowienia_tf.focus();
            break;
           */ 
...
bt1.addEventListener('click', function(){
    ...
    if (zamow.numer === '' || zamow.nazwa === '' || zamow.date_start === '' || zamow.date_stop === '') {
        var alertDialog = Titanium.UI.createAlertDialog({
